...
exports.createCustomer = async (req, res) => {
  ...
  try {
    ...
    //   expense.name=;
    expense.firstname = null;
    expense.address = null;
    expense.phoneNumber = null;
    expense.profile = null;
    expense.sex = null;
    expense.dateOfBirth = null;
...
exports.getCustomer = async (req, res) => {
  const customerId = req.params.id;
  try {
    const customer = await Customer.findById(customerId).populate("sex");
    if (!customer) {
...
exports.registration = async (req, res) => {
  ...
  try {
    if (
      ...
      customer.confirmationPassword == null
    ) {
...
exports.choosePreferredService = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "An error occurred while choosing service preference" });
  }
};
...
exports.choosePreferredEmployee = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "An error occurred while choosing employee preference" });
  }
};
